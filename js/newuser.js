...
function postToServer(e) {
  e.preventDefault();
  var querryStr = "https://nusmoneybe.onrender.com/login?email=" + email.value;
...
function loginValidation(data) {
  ...
  if ((email.value == "") || (pass.value == "") || (firstName.value == "") || (lastName.value == "")) {
    ...
    var querryLogin = "https://nusmoneybe.onrender.com/new/login";
    var querryAsset = "https://nusmoneybe.onrender.com/new/asset";
    var querryUser = "https://nusmoneybe.onrender.com/new/user";
